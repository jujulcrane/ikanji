...
export default function Dashboard() {
  ...
  const lesson9: Lesson = {
    name: "Lesson 9",
    kanjiList: [
      { character: "午", meaning: "noon", strokeOrder: "someurl", readings: ["ご"] },
      { character: "後", meaning: "after", strokeOrder: "someurl", readings: ["ご", "こう"] },
      { character: "前", meaning: "before", strokeOrder: "someurl", readings: ["ぜん", "まえ"] },
      { character: "名", meaning: "name", strokeOrder: "someurl", readings: ["めい", "な"] },
      { character: "白", meaning: "white", strokeOrder: "someurl", readings: ["しろ", "はく"] },
      { character: "雨", meaning: "rain", strokeOrder: "someurl", readings: ["あめ", "う"] },
      { character: "書", meaning: "to write", strokeOrder: "someurl", readings: ["しょ", "か"] },
      { character: "友", meaning: "friend", strokeOrder: "someurl", readings: ["とも", "ゆう"] },
      { character: "間", meaning: "between", strokeOrder: "someurl", readings: ["あいだ", "かん"] },
      { character: "家", meaning: "house", strokeOrder: "someurl", readings: ["いえ", "か"] },
      { character: "話", meaning: "to talk", strokeOrder: "someurl", readings: ["はなし", "わ"] },
      { character: "少", meaning: "few", strokeOrder: "someurl", readings: ["しょう", "すこ"] },
      { character: "古", meaning: "old", strokeOrder: "someurl", readings: ["ふる", "こ"] },
      { character: "知", meaning: "to know", strokeOrder: "someurl", readings: ["し", "しる"] },
      { character: "来", meaning: "to come", strokeOrder: "someurl", readings: ["らい", "く"] },
    ],
    practiceSentences: [
      { japanese: "午前9時に学校に行きます。", english: "I go to school at 9 AM." },
      { japanese: "午後に友達と遊びます。", english: "I play with my friends in the afternoon." },
      { japanese: "前に行ったことがありますか？", english: "Have you been there before?" },
      { japanese: "名前は何ですか？", english: "What is your name?" },
      { japanese: "彼の白いシャツは綺麗です。", english: "His white shirt is clean." },
      { japanese: "雨が降っています。", english: "It is raining." },
      { japanese: "毎日、日記を書きます。", english: "I write in my diary every day." },
      { japanese: "友達と一緒に映画を見ます。", english: "I watch a movie with my friend." },
      { japanese: "図書館と家の間に公園があります。", english: "There is a park between the library and my house." },
      ...
      { japanese: "古い本を読んでいます。", english: "I am reading an old book." },
      { japanese: "彼はそのことを知っています。", english: "He knows about that." },
