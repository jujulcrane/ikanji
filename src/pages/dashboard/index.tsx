        ...
        <div className="bg-customCream py-2 w-3/4 rounded-sm px-4 lg:w-2/3">
          ...
          <ul className="flex justify-center items-center gap-8 mt-4">
            <li className="flex items-center gap-2">
              <FaBrain />
              <Link href="/dashboard/my-lessons" className="hover:underline">
        ...
        <div className="flex lg:w-2/3 flex-col lg:flex-row items-center bg-cover bg-center relative p-10">
          ...
          <div className="lg:mt-12 lg:mx-10 relative z-10 text-center text-customCream py-6 lg:ml-10">
            <p className="lg:mb-10 md:text-lg md:px-6 mb-4 text-sm text-left">
              Are you a Genki student? Take your learning to the next level by
              adding pre-made Kanji lessons from Genki Book 1. Each lesson
              includes the exact same kanji covered in the corresponding
              chapter, allowing you to master the material as you progress
              through the book. These lessons are designed to enhance your
              learning experience and help you achieve a deeper understanding of
