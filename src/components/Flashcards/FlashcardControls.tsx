  ...
  return (
    <div className="mt-8 flex justify-center items-center">
      <div className="flex items-center space-x-2 m-2">
        <button
          className="bg-blue-400 text-white rounded-sm p-1 px-2 text-sm mr-2 hover:opacity-50 cursor-pointer"
          onClick={() =>
            router.push({
        ...
        <button
          className="rounded-sm p-1 px-2 text-sm bg-customCream hover:opacity-70 cursor-pointer"
